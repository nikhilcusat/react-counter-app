...
function App() {
  ...
  return (
    ...
    <div className="w-[100vw] h-[100vh] flex justify-center items-center bg-[#344151] flex-col gap-10">
      <div className="text-blue-900 font-medium text-2xl">Increment && Decrement</div>
      ...
      <div className="font-bold gap-12 text-5xl">
        ...
        <button onClick={increaseHandler} className="border-l-2 text-center w-20 border-[#bfbfbf] text-5x">
          +
        </button>
